 ...
 * Title + body copied verbatim from https://city-talks.gr.
 */
export const principles = [
  {
    n: "01",
    title: "Γράφουμε για τους Δήμους, συζητάμε για τις πόλεις μας",
    body:
      "αναλύουμε τη διοίκηση, τις πολιτικές και τις υπηρεσίες που αφορούν τους δημότες. Συζητώντας για τις πόλεις μας, εξερευνούμε την καθημερινότητα, την πολιτιστική ταυτότητα και τις προκλήσεις που επηρεάζουν τη ζωή στο αστικό περιβάλλον.",
  },
  {
    n: "02",
    title: "Άνθρωποι της Αυτοδιοίκησης καταθέτουν τις απόψεις τους",
    body:
      "ενσαρκώνοντας την τοπική εξουσία και διαχείριση, παρουσιάζουν τις απόψεις και τις προτάσεις τους για τη βελτίωση των δημοτικών υπηρεσιών και την ανάπτυξη των κοινοτήτων. Μέσα από την κατάθεση των απόψεων τους, στοχεύουν στη δημιουργία πιο λειτουργικών και ανθρώπινων πόλεων, ενισχύοντας τον διάλογο με τους πολίτες και προάγοντας τη δημοκρατία στο τοπικό επίπεδο.",
  },
  {
    n: "03",
    title: "Οι απόψεις δεν λογοκρίνονται, εκφράζουν τους συντάκτες τους",
    body:
      "κάθε συντάκτης έχει την ελευθερία να εκφράζει τις προσωπικές του ιδέες και πεποιθήσεις. Αυτό δημιουργεί έναν πλούσιο διάλογο, όπου οι διαφορετικές φωνές και προοπτικές εμπλουτίζουν τη συζήτηση, ενισχύοντας τη δημοκρατική έκφραση και την κοινωνική πρόοδο.",
  },
] as const;
